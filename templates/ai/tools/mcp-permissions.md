...
| Read local generated SDK/Biz logs | Allowed when relevant | Use latest matching log after process exit |
...
- DeviceSdk: `C:\Windows\Temp\ExampleSdkLog\SDK_*.log`
- CoreServicesLib Biz: `C:\Windows\Temp\NativeBridgeLog\NativeBridge_*.log`

Prefer the latest matching file after closing the DesktopShell process.
