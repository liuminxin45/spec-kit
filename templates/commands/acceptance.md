---
description: Generate user acceptance instructions and checklist for a completed CoreServicesLib capability.
scripts:
...
5. Classify every proposed verification item before writing acceptance:
   - `AI automated validation`: unit tests, integration tests, modelled thread
     ...
     host-embedded frontend plugins, prefer real DesktopShell Electron CDP
     ...
     available: launch/reuse DesktopShell, operate the flow, inspect
