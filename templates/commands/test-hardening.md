...
scripts:
  ps: scripts/powershell/check-prerequisites.ps1 -Json -Stage test-hardening
---
...
`validation.md`, plus the active `workpack.md`/`plan.md`/`tasks.md` needed to judge regression risk. Optional
...
6. If not useful, record optional N/A in lean `workpack.md` `Outcome` or
   strict `implementation-summary.md`.
7. Update strict `validation.md` with new commands/results only when new
   validation ran.
