...
**能力 / 缺陷 / 迁移目标**: [名称或摘要]
**Affected Area**: [SDK, ProductNativePlugin/NativeBridge bridge, DesktopShell, frontend plugin,
...
**疑似层级**: [SDK, ProductNativePlugin/NativeBridge bridge, frontend plugin, runtime/device,
tooling, unknown]
...
- **NativeBridge 边界**: [forwarding bridge only / unknown / N/A；不得写业务逻辑]
- **CoreServicesLib 事实来源**: [runtime/permission/capability/device facts 来源，或 unknown / N/A]
...
| Target frontend/plugin | [path or N/A] | migration/new-feature | ProductUIPlugin、ProductSuite plugin 或其他 UI implementation target |
