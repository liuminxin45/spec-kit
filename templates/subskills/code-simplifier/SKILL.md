...
This is an executable subskill installed under `.agents/skills`. Long-term L4
tool guidance lives in `ai/tools/*` when a tool action needs it. Use
`ai/tools/mcp-usage-policy.md` and `ai/tools/mcp-permissions.md` before adding
tool-assisted evidence during simplification. Preserve behavior exactly.
