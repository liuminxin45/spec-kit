...
The CoreServicesLib team build keeps self-check local and non-networked. The
...
def _fetch_latest_release_tag() -> tuple[str | None, str | None]:
    ...
    return None, "remote version check disabled in the CoreServicesLib team build"
...
def self_check() -> None:
    ...
    if tag is None:
        ...
        console.print("To reinstall from the team source, run:")
        console.print(r"  .\script\SpecKit\install.ps1")
        return
