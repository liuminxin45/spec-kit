...
SCRIPT_TYPE_CHOICES = {"ps": "PowerShell", "py": "Python"}
...
from .workflows.commands import register_workflow_commands as _register_workflow_commands

_register_workflow_commands(app, _require_specify_project)
